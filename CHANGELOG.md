...
- [x] revising the `readDvDatasetMetadata` method to provide instruction if the dataset description file is not present
- [x] revising the notice when the Notebook configuration is complete for plugins
